...
export default function Autopilot(){
 const {publicKey,signMessage}=useWallet(); const [data,setData]=useState<Data|null>(null); const [stopping,setStopping]=useState(false); const [notice,setNotice]=useState("");
